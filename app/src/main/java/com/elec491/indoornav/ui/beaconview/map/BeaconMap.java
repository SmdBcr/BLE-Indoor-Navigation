...
import com.elec491.indoornav.ui.LocationAnimator;
...
public class BeaconMap extends BeaconView {
    ...
    protected void drawDevice(Canvas canvas) {
        ...
        //PointF deviceCenter = new PointF(500,850);
    ...
    protected void drawDeviceHistory(Canvas canvas) {
        ...
        for (Location location : recentLocations) {
            ...
            recencyScore = getRecencyScore(location.getTimestamp(), TimeUnit.SECONDS.toMillis(1));
    ...
    protected void drawBeacons(Canvas canvas) {
        ...
        for (Beacon beacon : beacons) {
            ...
            //PointF beaconCenter = getPointFromLocation(new Location(41.205060, 29.070720));
    ...
    public void onDeviceLocationChanged() {
        ...
        Iterator it = beaconCenterMap.entrySet().iterator();
        ...
        while (it.hasNext()) {
            ...
            float dist = distanceToBeacon(deviceCenter, (PointF)pair.getValue());
            if (dist < min)
                result = i;
        ...
        BeaconMuseum.printArtifact(result);
...
*/
    ...
    public float distanceToBeacon(PointF device, PointF beaceon) {
        return (device.x - beaceon.x) * (device.x - beaceon.x) + (device.y - beaceon.y) * (device.y - beaceon.y);
    }
