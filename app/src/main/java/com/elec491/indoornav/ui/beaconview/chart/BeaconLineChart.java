package com.elec491.indoornav.ui.beaconview.chart;
...
import com.elec491.indoornav.ui.beaconview.ColorUtil;
    ...
    protected void onValueTypeChanged() {
        ...
        switch (valueType) {
            ...
            case VALUE_TYPE_RSSI_FILTERED: {
                ...
                yAxisMaximumAnimator = startValueAnimator(yAxisMaximumAnimator, -30);
                yAxisMinimumAnimator = startValueAnimator(yAxisMinimumAnimator, -100);
                break;
            }
